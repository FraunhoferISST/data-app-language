...
@PolicyAnnotation("DenyUsernameJwt")
class DenyUsernameJwt : EmbeddedPolicyApi {

    val logger = LoggerFactory.getLogger("DenyUsernameJwt")!!
    ...
    override fun acceptPrecondition(policyInput : PolicyInputScope): Boolean {
        ...
        if (username == currentUsername) {
            logger.error("Validation failed. JWT Username '$username' is forbidden but " +
