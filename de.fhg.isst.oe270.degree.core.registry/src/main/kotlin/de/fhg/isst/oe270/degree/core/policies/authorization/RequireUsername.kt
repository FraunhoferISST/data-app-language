...
@PolicyAnnotation("RequireUsername")
class RequireUsername : EmbeddedPolicyApi {

    val logger = LoggerFactory.getLogger("RequireUsername")!!
    ...
    override fun acceptPrecondition(policyInput : PolicyInputScope): Boolean {
        ...
        if (username != currentUsername) {
            logger.error("Validation failed. Required username is '$username' but " +
