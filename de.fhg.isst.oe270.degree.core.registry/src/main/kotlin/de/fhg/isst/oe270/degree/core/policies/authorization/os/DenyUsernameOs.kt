...
@PolicyAnnotation("DenyUsernameOs")
class DenyUsernameOs : EmbeddedPolicyApi {

    val logger = LoggerFactory.getLogger("DenyUsernameOs")!!
    ...
    override fun acceptPrecondition(policyInput : PolicyInputScope): Boolean {
        ...
        if (username == currentUsername) {
            logger.error("Validation failed. Os Username '$username' is forbidden but " +
