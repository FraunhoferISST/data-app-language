...
@PolicyAnnotation("QuotaWriteFile")
class QuotaWriteFile: QuotaFile() {
    override fun getPermissionType(): DegreePermissionType {
        return DegreePermissionType.WRITE_FILE
    }

    override fun getByteOptionName(): String {
        return DegreeFileOperations.WRITTEN_BYTES
    }
