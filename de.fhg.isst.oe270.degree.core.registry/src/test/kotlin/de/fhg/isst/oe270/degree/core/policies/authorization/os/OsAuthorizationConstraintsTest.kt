...
class OsAuthorizationConstraintsTest {
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does reject missing input`() {
        val inputScope = PolicyInputScope()

        val constraint = RequireUserroleOs()
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does reject wrong input type`() {
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does reject wrong role`() {
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does reject wrong role from list`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does accept correct role`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_RequireUserroleOs does accept correct role from list`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_RequireUsernameOs does reject missing input`() {
        val inputScope = PolicyInputScope()

        val constraint = RequireUsernameOs()
        val result = constraint.acceptPrecondition(inputScope)
    ...
    @Test
    fun `Test that constraint core_RequireUsernameOs does reject wrong input type`() {
    ...
    @Test
    fun `Test that constraint core_RequireUsernameOs does reject wrong username`() {
    ...
    @Test
    fun `Test that constraint core_RequireUsernameOs does accepts correct username`() {
        val username = typeTaxonomy.create(Identifier.of("core.Username"))
        username.write(usernameA)
        val inputScope = PolicyInputScope()
        inputScope.add("username", username)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does reject missing input`() {
        val inputScope = PolicyInputScope()

        val constraint = DenyUserroleOs()
        val result = constraint.acceptPrecondition(inputScope)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does reject wrong input type`() {
        val role = typeTaxonomy.create(Identifier.of("core.Error"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does reject matching role`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does reject matching role from list`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does accepts non-matching role`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_DenyUserroleOs does accepts non-matching role from list`() {
        val role = typeTaxonomy.create(Identifier.of("core.Userrole"))
        role.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("role", role)
    ...
    @Test
    fun `Test that constraint core_DenyUsernameOs does reject missing input`() {
        val inputScope = PolicyInputScope()

        val constraint = DenyUsernameOs()
        val result = constraint.acceptPrecondition(inputScope)
    ...
    @Test
    fun `Test that constraint core_DenyUsernameOs does reject wrong input type`() {
        val username = typeTaxonomy.create(Identifier.of("core.Error"))
        username.write(userroleA)
        val inputScope = PolicyInputScope()
        inputScope.add("username", username)
    ...
    @Test
    fun `Test that constraint core_DenyUsernameOs does accept non-matching username`() {
        val username = typeTaxonomy.create(Identifier.of("core.Username"))
        username.write(usernameA)
        val inputScope = PolicyInputScope()
        inputScope.add("username", username)
    ...
    @Test
    fun `Test that constraint core_DenyUsernameOs rejects matching username`() {
        val username = typeTaxonomy.create(Identifier.of("core.Username"))
        username.write(usernameA)
        val inputScope = PolicyInputScope()
        inputScope.add("username", username)
