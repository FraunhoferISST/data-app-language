...
/**
 * This is a D° application which offers a HTTP-interface and periodic, controllable execution
 * of its logic.
 */
public abstract class HttpDataAppPeriodic extends HttpDataApp {
     ...
     * This is the time in ms between two executions of the application logic
     * if operated in periodic mode.
     *
